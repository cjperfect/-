...
if(phpversion() < '5.2.0')
{
	exit('用户您好，由于您的php版本过低，不能安装本软件，为了系统功能全面可用，请升级到5.2.0或更高版本再安装，谢谢！<br />您可以登录 hbxnseo.com 获取更多帮助');
}

$myfile=$_SERVER['DOCUMENT_ROOT'].'/webconfig.php';
...
$locksorce="/install_lock.txt";//锁定文件路径

//提示已经安装
if(is_file(INSTALL_PATH.$locksorce) and @$_GET['s'] != md5('done'))
{
...
switch($s)
{
	...
	$fp = fopen(INSTALL_PATH.$locksorce, 'w');
